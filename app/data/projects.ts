...
export const PERSONAL_PROJECTS: PersonalProject[] = [
  {
    ...
    githubLink: "https://github.com/Engineernoob/opshub-api", // update if needed
    liveLink: "https://opshub-api.onrender.com",
    featured: true,
    role: "Solo build",
    highlights: [
  ...
  },
  {
    ...
    githubLink: "https://github.com/Engineernoob/ratio-web",
    featured: true,
    role: "Solo build",
    highlights: [
